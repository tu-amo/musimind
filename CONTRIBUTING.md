...
* [reporting an issue](CONTRIBUTING.md##reporting-an-issue)
    ...
    * [change requests](CONTRIBUTING.md##change-requests)
* [working on MathJax core](CONTRIBUTING.md##working-on-mathjax-core)
    * [key branches and tags](CONTRIBUTING.md##key-branches--tags)
    * [submitting pull requests](CONTRIBUTING.md##submitting-pull-requests)
    * [testing and quality assurance](CONTRIBUTING.md##testing-and-quality-assurance)
    * [writing documentation](CONTRIBUTING.md##writing-documentation)
    * [translation](CONTRIBUTING.md##translation)
* [Conduct](CONTRIBUTING.md##conduct)
...
preferred channel for [bug reports](CONTRIBUTING.md##bug-reports), [feature
requests](#feature-requests), [change requests](CONTRIBUTING.md##change-requests), and
[submitting pull requests](CONTRIBUTING.md##submitting-pull-requests), but please
...
* Please **be civil**. Keep the discussion on topic and respect the
  opinions of others. See also our [Conduct Guidelines](CONTRIBUTING.md.md##conduct)
...
6. Use the [Bug Report Template](CONTRIBUTING.md##template) below or [click this
...
2. Take a moment to think about the best way to make a case for, and
   ...
   a [bug report](CONTRIBUTING.md.md.md##bug-reports) or a [feature
...
requests following the [pull-request](CONTRIBUTING.md.md.md##submitting-pull-requests)
guidelines.
